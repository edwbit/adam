...
body = "Provide a list of 3 key points with expounded parallel biblical accounts  to makethe point clearer. Provide critical question, a controversy, a rebuke, a dichotomy each point. Do this while defending {{selected_doctrine}"
conclusion = "Provide a summary and call to action. Do this while defending {{selected_doctrine}"
