...
#structure
introduction = "State the bible text. State a provocative question that challenges current thinking. Make it relevant to people's daily lives. Provide a factual story, related world data, trivia or statistics. Contrast modern day christians and biblical accounts that would help answer the question asked."
